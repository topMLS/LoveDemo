...
public class LoveView extends RelativeLayout {
    ...
    private Handler handler=new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            ...
            sums=sums+10;
            if (time-sums>0){
                handler.sendMessageDelayed(Message.obtain(),time-sums);
            }
            return false;
        }
    });
    ...
    private void init() {
        ...
        mDrawables[0] = getResources().getDrawable(R.drawable.pl_blue);
        mDrawables[1] = getResources().getDrawable(R.drawable.pl_red);
        mDrawables[2] = getResources().getDrawable(R.drawable.pl_yellow);
        mDrawableWidth = mDrawables[0].getIntrinsicWidth();
        mDrawableHeight = mDrawables[0].getIntrinsicHeight();
        params = new LayoutParams(mDrawableWidth / 2, mDrawableHeight / 2);
    ...
    private void initPointF() {
        p0 = new PointF(screenWidth - 60 - mDrawableWidth / 2, screenHeight - 60 - mDrawableHeight / 2);//起点是初始化时的点
